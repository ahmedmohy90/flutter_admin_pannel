...
class ProductVariations extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            ListView.separated(
              shrinkWrap: true,
              itemBuilder: (_, index) {
                final vatiation = variationController.productVariations[index];
                return _buildVariationTile(context, index, vatiation, variationController);
              },
  ...
  Widget _buildVariationTile(
    ...
    return ExpansionTile(
      ...
      title: Text(variation.attributesValues.entries.map((entry)=> '${entry.key}: ${entry.value}').join(', ')),
      children: [
        Obx(
          () => TImageUploader(
            right: 0,
        ...
        TextFormField(
          ...
          controller: variationController.discriptionControllerList[index][variation],
          decoration: const InputDecoration(
